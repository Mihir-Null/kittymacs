...
Fonts have already initialized. The dashboard renders the kittymacs banner, three button rows, bounded lists from core editor facilities and the key guide; the last insertion pass applies pixel-based centering.
